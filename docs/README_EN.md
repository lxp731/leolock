...
A secure personal file encryption CLI tool using AES-256-GCM and Argon2id.
...
- **Zero Memory Residue**: `zeroize` ensures passwords and keys are wiped immediately after use.
- **High Performance**: Streaming I/O, ~14s for 3GB files.
